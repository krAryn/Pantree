...
const Footer = () => {
    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-primary/10 relative ">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
                <div>
                    <Link to="/"><img className="w-34 md:w-32" src={assets.logo} alt="logo" /></Link>
            ...
            <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
                Copyright {new Date().getFullYear()} © Pantree All Right Reserved.
            </p>
        </div>
    );
};
