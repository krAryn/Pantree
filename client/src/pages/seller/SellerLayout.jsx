...
const SellerLayout = () => {
    ...
    const sidebarLinks = [
        ...
        { name: "Products List", path: "/seller/productslist", icon: assets.product_list_icon },
        ...
        <div className='h-[100vh] w-[100vw] overflow-hidden'>
            <div className="flex items-center justify-between px-4 md:px-8 border-b border-gray-300 py-3 bg-white">
                ...
                <div className="flex items-center gap-5 text-gray-500">
                    <p>Hi! Admin</p>
                    <button onClick={logout} className='cursor-pointer border rounded-full text-sm px-4 py-1 transition hover:scale-[1.05]'>Logout</button>
                </div>
            </div>
