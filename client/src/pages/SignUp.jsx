        ...
        <div className="flex h-[100%] w-full">
            ...
            <div className="w-full flex flex-col items-center justify-center p-10 absolute lg:relative">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="md:w-96 w-80 flex flex-col items-center justify-center">
                    <h2 className="text-4xl text-gray-900 font-medium">Hey There!</h2>
                    <p className="text-sm text-gray-500/90 mt-3">Welcome to Pantree! Please Sign in to continue</p>
                    ...
                    <div className="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                        <img src={assets.user} className='h-[15px]' alt="" />
                        <input type="text" placeholder="Full Name" className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" 
                            {...register("fullname", { 
                    ...
                    {!isSubmitting? (
                        <input type="submit" value="Proceed to Sign Up" className="mt-8 w-full h-11 rounded-full text-white bg-primary hover:bg-primary-dull transition-opacity cursor-pointer" onClick={validate} />
                    ): (
                    ...
                    <p className="text-gray-500/90 text-sm mt-4">Already have an account? <Link className="text-primary hover:underline" to="/login">Log in</Link></p>
                </form>
            </div>
        </div>
    )
